...
class QGANHyperparameterOptimizer:
    def __init__(self, individuals_data):
        ...
        breakpoint()
        self.hyperparameters = [key for key in self.individuals[0] if key != 'objective_function_values']
...
if __name__ == "__main__":
    ...
    optimizer = QGANHyperparameterOptimizer(individuals)
